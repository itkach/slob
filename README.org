...
** Installation
   ...
   #+BEGIN_SRC sh
   sudo apt-get install python3 python3-icu python3-virtualenv git
   #+END_SRC
...
*** Create from Wikimedia Enterprise HTML Dumps or MediaWiki API:

    See https://github.com/itkach/mw2slob
